...
SENDGRID_EMAIL_USERNAME = os.environ.get('ROOTCAUSE_SENDGRID_USERNAME') or 'rootcause'  #export ROOTCAUSE_SENDGRID_USERNAME='rootcause'
SENDGRID_EMAIL_PASSWORD = os.environ.get('ROOTCAUSE_SENDGRID_PASSWORD') or 'r00t@Caus3' #export ROOTCAUSE_SENDGRID_PASSWORD='r00t@Caus3'
